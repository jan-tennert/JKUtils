...
fun readLong() : Long {
    return Scanner(System.`in`).nextLong()
}
...
fun readFloat() : Float {
    return Scanner(System.`in`).nextFloat()
}

fun readBigInteger() : BigInteger {
    return Scanner(System.`in`).nextBigInteger()
}

fun readBigDecimal() : BigDecimal {
    return Scanner(System.`in`).nextBigDecimal()
}

fun readShort() : Short {
    return Scanner(System.`in`).nextShort()
}